    ...
    const handleModalSubmit = async (formData) => {
        ...
        try {
            if (modalAction === 'add') {
                ...
                console.log(ciruclarData, "<-------------------------adjfhajkdfsdhfhsdkjfhsdjkf-------------------------->");
                await dispatch(updateCircularNotice({id, ciruclarData}));
...
//         try {
//             if (modalAction === 'add') {
//                 await dispatch(addCircularNotice(data));
//                 toast.success('Circular Notice added successfully.');
//             } else if (modalAction === 'update') {
//                 console.log(data, "<-------------------------adjfhajkdfsdhfhsdkjfhsdjkf-------------------------->")
//                 await dispatch(updateCircularNotice({ id: data._id, data }));
//                 toast.success('Circular Notice updated successfully.');
//             } else if (modalAction === 'delete') {
//                 await dispatch(deleteCircularNotice(data._id));
//                 toast.success('Circular Notice deleted successfully.');
//             }
