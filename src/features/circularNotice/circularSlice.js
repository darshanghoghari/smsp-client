...
export const fetchCircularNotices = createAsyncThunk('circularNotice/getDetail', async () => {
    try {
        ...
        console.log(response.data, '<----------------------circularNotices ----------------------->');
...
export const updateCircularNotice = createAsyncThunk('circularNotice/updateDetail', async ({ id, ciruclarData }) => {
    try {
        const token = getToken();
        console.log(id, "<------------------------------data log-------------------------->", ciruclarData);
        const response = await axios.put(`${baseURL}circularNotice/update/${id}`, ciruclarData, {
            headers: {
                Authorization: `Bearer ${token}`
            }
        });
...
// export const updateCircularNotice = createAsyncThunk('circularNotice/updateDetail', async ({ id, data }) => {
//     try {
//         const token = getToken();
//         console.log(id, "<------------------------------data log-------------------------->", data);
//         delete data._id;
//         const response = await axios.put(`${baseURL}circularNotice/update/${id}`, data, {
//             headers: {
//                 Authorization: `Bearer ${token}`
//             }
//         });
